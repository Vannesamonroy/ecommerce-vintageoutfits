    ...
    >
      ...
      <figure className="md:px-6 flex justify-center">
        <img
          ...
          src={context.productToShow.attributes?.images.data[0].attributes?.url}
          alt={context.productToShow.attributes?.title}
        />
      </figure>
      <p className="flex flex-col p-6">
        <span className="font-medium text-2xl">${context.productToShow.attributes?.price}</span>
        <span className="font-medium text-xl">{context.productToShow.attributes?.title}</span>
        <span>{context.productToShow.attributes?.description}</span>
      </p>
